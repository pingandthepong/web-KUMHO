 ...
 - ${i}: ${e}`),
            ...
            constructor(t, e, i, s, r, o, a) {
              ...
              a || l.css(this.getStyle(s || {})),
                ...
                this.createElement("desc")
                  .add()
                  .element.appendChild(
                    p.createTextNode("Created with Highcharts 11.4.1")
                  ),
          ...
          class k {
            ...
            destroy() {
              if (!this.destroyed) {
                ...
                t.legendItem && i.legend.destroyItem(t),
                  ...
                  s && s.enabled
                    ? (this.animateBeforeDestroy(), b(n, a.duration))
                    : n(),
                  i.pointCount--;
              }
              this.destroyed = !0;
            ...
            optionsToObject(t) {
              ...
              if (f(t) || null === t) o[s[0]] = t;
                ...
                for (
                  ...
                  (i && void 0 === t[n]) ||
                    (s[h].indexOf(".") > 0
                      ? k.prototype.setNestedProperty(o, t[n], s[h])
                      : (o[s[h]] = t[n])),
                    n++,
                    h++;
              else
            ...
            resolveColor() {
              ...
              delete this.nonZonedColor,
                ...
                (this.color = y(this.options.color, s));
            }
            ...
            update(t, e, i, s) {
              ...
              function d() {
                ...
                n && d && ((o.graphic = n.destroy()), delete o.hasMockGraphic),
                  ...
                  (l.data[r] =
                    m(l.data[r], !0) || m(t, !0) ? o.options : y(t, l.data[r])),
            ...
            manageEvent(t) {
              let e = x(this.series.options.point, this.options),
                i = e.events?.[t];
              g(i) &&
              (!this.hcEvents?.[t] ||
              ...
              if (
                ...
                if (
                  ...
                  (v = s.pointAttribs(this, e)),
                    (S = y(g.options.chart.animation, o.animation));
                  let t = v.opacity;
                ...
                b &&
                  this.graphic.animate(
                    b,
                    y(g.options.chart.animation, l.animation, n.animation)
                  ),
                  k && k.hide();
              } else
                e &&
                ...
                ? (x || (s.halo = x = g.renderer.path().add(w.parentGroup)),
                  ...
                  x.attr({
                    class:
                      ...
                      y(this.colorIndex, s.colorIndex) +
      ...
      i(
        ...
        function (t, e, i) {
          var s;
          let { parse: r } = t,
            { charts: o, composed: a, isTouchDevice: n } = e,
            {
              addEvent: h,
              attr: l,
              css: d,
          ...
          class S {
            ...
            getChartCoordinatesFromPoint(t, e) {
              ...
              if (i && s) {
                let o = t.clientX ?? t.plotX ?? 0,
                  a = t.plotY || 0;
                return (
                  t.isNode && r && g(r.x) && g(r.y) && ((o = r.x), (a = r.y)),
                  e
              ...
              let e = this,
                ...
                n =
                  ...
                  ((e.inClass(t.target, "highcharts-tracker") &&
                    ...
                    e.runChartClick),
                h = i.tooltip,
                l = 1 === a && y(h?.options.followTouchMove, !0);
            ...
            runPointActions(t, e, i) {
              let s = this.chart,
                ...
                u = this.getHoverData(l, d, r, c, n, t);
          ...
          class Q {
            ...
            transform(t) {
              ...
              e)) {
                ...
                let C = t.toValue(S, !0) + (o ? 0 : p * k),
                  M = t.toValue(S + c / b, !0) - (o ? 0 : p * k || 0),
                  w = t.allExtremes;
                if (
                  (C > M && ([C, M] = [M, C]),
